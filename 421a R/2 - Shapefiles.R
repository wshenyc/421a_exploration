...
pluto_small_permit <- st_read("/Users/winnieshen/Documents/GitHub/421a_exploration/Data/pluto_small_permit_updated_v2.shp")

boro <- st_read("/Users/winnieshen/Documents/GitHub/421a_exploration/Data/nybb.shp")

# Write the sf object to a GeoJSON file

#st_write(pluto_small_permit, dsn = "/Users/winnieshen/Documents/GitHub/421a_exploration/Data/lots_421a.geojson")
